...
alert(err);
  ...
  return (
   ...
   <div className="htmlm-group">
    <label htmlFor="exampleInputEmail1"> New User Registration/Sign up</label>
  ...
  <button type="submit" className="btn btn-primary" style={{margin:"50 px"}}>Registration/Sign Up</button>
</form>
